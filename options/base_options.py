...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--name', type=str, default='full3D100epoch10xdatanoVGGTFResampleBS2', help='name of the experiment. It decides where to store samples and models')
