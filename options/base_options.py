...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--name', type=str, default='128img3DnewdiscriminatorL1lossparam10noVGGtry2', help='name of the experiment. It decides where to store samples and models')
