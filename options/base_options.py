...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--name', type=str, default='UnetlossSherlockBS2Epoch100DataX10L1andUnet10factor', help='name of the experiment. It decides where to store samples and models')
