...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--name', type=str, default='3DwithlastgeneratedSherlockCONTINUED', help='name of the experiment. It decides where to store samples and models')
