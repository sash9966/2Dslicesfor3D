...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--name', type=str, default='512img3DnewdiscriminatorL1lossparam10noVGG', help='name of the experiment. It decides where to store samples and models')
