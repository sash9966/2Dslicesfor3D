...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--multi_data',type= int, default=1, help='number of times the training data gets repeated, default is 10, dataaugmentation should be turned on!')
