...
class TrainOptions(BaseOptions):
    def initialize(self, parser):
        ...
        parser.add_argument('--save_epoch_freq', type=int, default=50000, help='frequency of saving checkpoints at the end of epochs')
        ...
        parser.add_argument('--niter', type=int, default=15, help='# of iter at starting learning rate. This is NOT the total #epochs. Totla #epochs is niter + niter_decay')
